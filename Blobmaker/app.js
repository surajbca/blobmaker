!(function (f, t, e, n, h) {
  try {
    ...
    var st = function (e, t, n) {
        (e = n ? e : Y(At, $t, e)), v.brave && !n && (e.brave = d);
        var r = new Image();
      ...
      lt = ut || y,
      pt = { version: "custom_latest_10", hostname: lt };
    (n = function (t) {
    ...
    if (
      ((At.sri = m),
      k && ((At.mobile = k.mobile), (At.brands = S(k.brands))),
      _.doctype || h("Add DOCTYPE html for accurate dimensions"),
      lt !== y && (At.hostname_original = y),
      !gt && u in v && "1" == v[u])
    )
    ...
    var qt,
      ...
      kt = function (t, e) {
        var n;
        St &&
          ((n = Y(pt, { type: "append", original_id: e ? t : At.page_id })),
          K("t") && (n.duration = Math.round((Q() - ht - jt) / 1e3)),
          (jt = 0),
          (ht = Q()),
          K("scro") && (n.scrolled = Math.max(0, dt, Ht())),
          e || !v.sendBeacon ? st(n, i, d) : v.sendBeacon(q + "/append", S(n)));
      };
    A(
      "visibilitychange",
      function () {
        ...
        if (r && qt != r) {
          (qt = r),
            ...
            K("v") &&
              ...
              ($t.viewport_height =
                Math.max(M[R] || 0, f.innerHeight || 0) || null)),
            K("l") && v[$] && ($t[$] = v[$]),
            B &&
              K("sc") &&
          ...
          var l = function () {
            (E = d),
              (function (t, e, n, r) {
                t && kt("" + At.page_id, d), St && (At.page_id = X());
                var a = lt + Rt();
                st({
                  id: At.page_id,
                  type: g,
            ...
            try {
              k && tt(k.getHighEntropyValues)
                ? k
                    ...
                    .then(function (t) {
                      (At.os_name = t[T]), (At.os_version = t[U]), l();
                    })
                    ["catch"](l)
                : l();
            } catch (p) {
